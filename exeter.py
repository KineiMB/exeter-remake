...
stream_url = "https://www.twitch.tv/exeterremake"
tts_language = "en"
...
async def on_connect():
    Clear()
    chole = Exeter.get_channel(826839715604987915)
    await chole.send(f"Watch `{tick}`")
    startprint()
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(
            name="Exeter Remake | Prefix: " + str(Exeter.command_prefix),
            icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723253781873164298/image1.gif"
        )
        embed.add_field(
            name="\uD83E\uDDCA `GENERAL`",
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723272273888280576/image0.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723266223554691202/image0.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723278609648713818/image0.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723270695185809468/image1.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/739548124493643837/ezgif.com-video-to-gif.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723268822789783612/image1.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723265016979259544/image0.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723274816055935067/image0.gif"
        )
        ...
        embed.set_image(
            url=
            "https://cdn.discordapp.com/attachments/723250694118965300/723256768742031451/image0.gif"
        )
